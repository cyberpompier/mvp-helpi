{/*
      ...
      1. Nouvelle fonctionnalité
        - Page dédiée pour le service "Guepes".
    ...
    const GuepesPage: React.FC = () => {
      ...
      return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white p-4">
          <h1 className="text-4xl font-bold mb-8 text-center">Destruction de Nuisibles (Guêpes)</h1>
          <p className="text-lg text-gray-300 mb-8 text-center">
            Informations détaillées sur la destruction des nids de guêpes et la prévention.
          </p>
          <img src="https://i.postimg.cc/c4Fk6NdW/guepes.jpg" alt="Image de guepe" className="w-full max-w-md rounded-lg shadow-lg mb-8" />
